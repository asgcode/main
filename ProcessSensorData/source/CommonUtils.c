...
/*******************************************************************************************************************************
*   ConvertBytesToEntries
*
*   @brief
*      Calculate number of 12 bit entries which can be formed from the given number of bytes
*
*   @return
*       number of entries
*
*******************************************************************************************************************************/
UINT ConvertBytesToEntries(
                           UINT numBytes)   ///< 
{
...
*
*   @brief
*      Calculate storage in bytes required to store given number of 12 bit entries assuming packed layout
*
*   @return
*      number of bytes
*
